...
let s:plugs_normal = [
			...
			\ [ 'wheel-prompt-read-wheel'                 , 'wheel#disc#read_wheel'                               ] ,
			\ [ 'wheel-prompt-write-wheel'                , 'wheel#disc#write_wheel'                              ] ,
			...
			\ [ 'wheel-history-newer'                     , 'wheel#waterclock#newer'                              ] ,
			\ [ 'wheel-history-older'                     , 'wheel#waterclock#older'                              ] ,
			\ [ 'wheel-history-newer-in-circle'           , "wheel#waterclock#newer('circle')"                    ] ,
			\ [ 'wheel-history-older-in-circle'           , "wheel#waterclock#older('circle')"                    ] ,
			\ [ 'wheel-history-newer-in-torus'            , "wheel#waterclock#newer('torus')"                     ] ,
			\ [ 'wheel-history-older-in-torus'            , "wheel#waterclock#older('torus')"                     ] ,
			\ [ 'wheel-prompt-history'                    , 'wheel#waterclock#history'                            ] ,
			\ [ 'wheel-dedibuf-history'                   , 'wheel#whirl#history'                                 ] ,
			\ [ 'wheel-alternate-anywhere'                , "wheel#caduceus#alternate('anywhere')"                ] ,
			\ [ 'wheel-alternate-same-torus'              , "wheel#caduceus#alternate('same_torus')"              ] ,
			\ [ 'wheel-alternate-same-circle'             , "wheel#caduceus#alternate('same_circle')"             ] ,
			...
			\ [ 'wheel-prompt-outline'                    , 'wheel#sailing#outline'                               ] ,
			...
			\ [ 'wheel-debug-prompt-history-circuit'      , 'wheel#waterclock#history_circuit'                    ] ,
...
let s:maps_level_0_normal = [
			...
			\ [ '<m-$>'        , 'wheel-sync-up'                            ] ,
			\ [ '$'            , 'wheel-sync-down'                          ] ,
			\ [ 'r'            , 'wheel-prompt-read-wheel'                  ] ,
			\ [ 'w'            , 'wheel-prompt-write-wheel'                 ] ,
			\ [ 'R'            , 'wheel-prompt-read-session'                ] ,
			\ [ 'W'            , 'wheel-prompt-write-session'               ] ,
...
let s:maps_level_2_normal = [
			...
			\ [ '<c-o>'              , 'wheel-prompt-outline'                    ] ,
			\ [ '<s-o>'              , 'wheel-dedibuf-outline'                   ] ,
