...
if ! exists('s:display')
	let s:display = {
				...
				\ 'Display locations on vertical splits, main left layout' : "wheel#mosaic#split('location', 'main_left')",
				...
				\ 'Display locations on vertical splits, main top layout' : "wheel#mosaic#split('location', 'main_top')",
