...
if ! exists('s:command_meta_prompt_actions')
	let s:command_meta_prompt_actions = [
				...
				\ [ 'yank-plain-linewise-after'  , 'wheel#codex#yank_plain'                    ] ,
				\ [ 'yank-plain-charwise-after'  , "wheel#codex#yank_plain('charwise-after')"  ] ,
				\ [ 'yank-plain-linewise-before' , "wheel#codex#yank_plain('linewise-before')" ] ,
				\ [ 'yank-plain-charwise-before' , "wheel#codex#yank_plain('charwise-before')" ] ,
				\ [ 'yank-list-linewise-after'   , 'wheel#codex#yank_list'                     ] ,
				\ [ 'yank-list-charwise-after'   , "wheel#codex#yank_list('charwise-after')"   ] ,
				\ [ 'yank-list-linewise-before'  , "wheel#codex#yank_list('linewise-before')"  ] ,
				\ [ 'yank-list-charwise-before'  , "wheel#codex#yank_list('charwise-before')"  ] ,
