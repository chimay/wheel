...
fun! wheel#centre#plugs ()
	...
	" Add
	nnoremap <expr> <plug>(wheel-add-here) wheel#tree#add_here()
	nnoremap <expr> <plug>(wheel-add-circle) wheel#tree#add_circle()
	nnoremap <expr> <plug>(wheel-add-torus) wheel#tree#add_torus()
	nnoremap <expr> <plug>(wheel-add-file) wheel#tree#add_file()
	nnoremap <expr> <plug>(wheel-add-buffer) wheel#tree#add_buffer()
	" Rename
	nnoremap <expr> <plug>(wheel-rename-location) wheel#tree#rename('location')
	nnoremap <expr> <plug>(wheel-rename-circle) wheel#tree#rename('circle')
	nnoremap <expr> <plug>(wheel-rename-torus) wheel#tree#rename('torus')
	nnoremap <expr> <plug>(wheel-rename-file) wheel#tree#rename_file()
	" Delete
