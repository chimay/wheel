...
fun! wheel#centre#mappings ()
	...
	if g:wheel_config.mappings >= 10
		...
		" Reshaping buffers
		nnoremap <D-r>        :call wheel#shape#reorganize()<cr>
		" Search inside files
		nnoremap <D-g>          :call wheel#sailing#grep()<cr>
		nnoremap <D-o>          :call wheel#sailing#outline()<cr>
		nnoremap <D-a>          :call wheel#sailing#symbol()<cr>
		" Search for files
		nnoremap <D-u>          :call wheel#sailing#attic()<cr>
		nnoremap <D-f>          :call wheel#sailing#locate()<cr>
		" Yank
		nnoremap <D-y>          :call wheel#clipper#yank('list')<cr>
		nnoremap <D-p>          :call wheel#clipper#yank('plain')<cr>
		" Batch
