...
contains dozen of novels in plain text format. You can add all of them at
once with a glob pattern. Press `<M-w>*` and wheel will ask you to enter
a glob pattern. You can answer `novels/*` to add all files in there. If
